...
public class V5_Flow extends Flow {
    ...
    public long dPkts = 0, dOctets = 0, First = 0, Last = 0, size =0;;
    ...
    public V5_Flow(String RouterIP, final byte[] buf, int off, Template t) throws
        ...
        // ����offset�ͳ���Ϊ�Ƿ�ֵ�����������
//        System.out.println("InBYTES_32  " +  t.getTypeOffset(FieldDefinition.InBYTES_32) + "  " + t.getTypeLen(FieldDefinition.InBYTES_32));
//        System.out.println("InPKTS_32  " +  t.getTypeOffset(FieldDefinition.InPKTS_32) + "  " + t.getTypeLen(FieldDefinition.InPKTS_32));
//        System.out.println("FLOWS  " +  t.getTypeOffset(FieldDefinition.FLOWS) + "  " + t.getTypeLen(FieldDefinition.FLOWS));
//        System.out.println("IPROT  " +  t.getTypeOffset(FieldDefinition.PROT) + "  " + t.getTypeLen(FieldDefinition.PROT));
//        System.out.println("SRC_TOS  " +  t.getTypeOffset(FieldDefinition.SRC_TOS) + "  " + t.getTypeLen(FieldDefinition.SRC_TOS));
//        System.out.println("TCP_FLAGS  " +  t.getTypeOffset(FieldDefinition.TCP_FLAGS) + "  " + t.getTypeLen(FieldDefinition.TCP_FLAGS));
//        System.out.println("L4_SRC_PORT  " +  t.getTypeOffset(FieldDefinition.L4_SRC_PORT) + "  " + t.getTypeLen(FieldDefinition.L4_SRC_PORT));
//        System.out.println("IPV4_SRC_ADDR  " +  t.getTypeOffset(FieldDefinition.IPV4_SRC_ADDR) + "  " + t.getTypeLen(FieldDefinition.IPV4_SRC_ADDR));
//        System.out.println("SRC_MASK  " +  t.getTypeOffset(FieldDefinition.SRC_MASK) + "  " + t.getTypeLen(FieldDefinition.SRC_MASK));
//        System.out.println("INPUT_SNMP  " +  t.getTypeOffset(FieldDefinition.INPUT_SNMP) + "  " + t.getTypeLen(FieldDefinition.INPUT_SNMP));
//        System.out.println("L4_DST_PORT  " +  t.getTypeOffset(FieldDefinition.L4_DST_PORT) + "  " + t.getTypeLen(FieldDefinition.L4_DST_PORT));
//        System.out.println("IPV4_DST_ADDR  " +  t.getTypeOffset(FieldDefinition.IPV4_DST_ADDR) + "  " + t.getTypeLen(FieldDefinition.IPV4_DST_ADDR));
//        System.out.println("DST_MASK  " +  t.getTypeOffset(FieldDefinition.DST_MASK) + "  " + t.getTypeLen(FieldDefinition.DST_MASK));
//        System.out.println("OUTPUT_SNMP  " +  t.getTypeOffset(FieldDefinition.OUTPUT_SNMP) + "  " + t.getTypeLen(FieldDefinition.OUTPUT_SNMP));
//        System.out.println("SRC_AS  " +  t.getTypeOffset(FieldDefinition.SRC_AS) + "  " + t.getTypeLen(FieldDefinition.SRC_AS));
//        System.out.println("DST_AS  " +  t.getTypeOffset(FieldDefinition.DST_AS) + "  " + t.getTypeLen(FieldDefinition.DST_AS));
//        System.out.println("BGP_NEXT_HOP  " +  t.getTypeOffset(FieldDefinition.BGP_NEXT_HOP) + "  " + t.getTypeLen(FieldDefinition.BGP_NEXT_HOP));
//        System.out.println("IPM_DPKTS  " +  t.getTypeOffset(FieldDefinition.IPM_DPKTS) + "  " + t.getTypeLen(FieldDefinition.IPM_DPKTS));
//        System.out.println("IPM_DOCTETS  " +  t.getTypeOffset(FieldDefinition.IPM_DOCTETS) + "  " + t.getTypeLen(FieldDefinition.IPM_DOCTETS));
//        System.out.println("LAST_SWITCHED  " +  t.getTypeOffset(FieldDefinition.LAST_SWITCHED) + "  " + t.getTypeLen(FieldDefinition.LAST_SWITCHED));
//        System.out.println("FIRST_SWITCHED  " +  t.getTypeOffset(FieldDefinition.FIRST_SWITCHED) + "  " + t.getTypeLen(FieldDefinition.FIRST_SWITCHED));
//        System.out.println("BYTES_64  " +  t.getTypeOffset(FieldDefinition.BYTES_64) + "  " + t.getTypeLen(FieldDefinition.BYTES_64));
//        System.out.println("TOTAL_BYTES_EXPORTED  " +  t.getTypeOffset(FieldDefinition.TOTAL_BYTES_EXPORTED) + "  " + t.getTypeLen(FieldDefinition.TOTAL_BYTES_EXPORTED));
//        
        ...
        //System.out.println(currOffset + " " + currLen);
...
//        System.out.println( currOffset + "  " + currLen);
        ...
        //        currOffset = t.getTypeOffset(FieldDefinition.IN_PERMANENT_BYTES);
//        
//        currLen = 4;
//        
//        
//        
//        if (currOffset >= 0 && currLen > 0) {
//            size = Util.to_number(buf, off + currOffset, currLen) *
//                      t.getSamplingRate();
//        }
