...
function setMainMenus() {
    ...
    for (var i = 0; i < els.length; i++) {
        ...
        if (nextLiState != null) {
            ...
            }else if(get_cookie('menuPanelType') == "Dashboard"){
        ...
        if (nextLiState == "none") {
            els[i].src = "images/down-arrow.gif";
        } else {
            els[i].src = "images/up-arrow.gif";
        }
    }
}
